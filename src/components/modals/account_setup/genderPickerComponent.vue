    ...
    <div class="w-full h-full flex overflow-auto md:py-[20px] bg-white md:bg-transparent">
      <div class="w-full max-w-[664px] h-full md:min-h-[640px] md:h-[640px] m-auto px-[40px] pt-[40px] pb-[40px] bg-white md:rounded-[24px]">
        <form @submit.prevent="handleSubmit" class="relative w-full h-full flex flex-col justify-between">
          <div
            @click="previousDatePickerComponent"
          ...
          <div class="mt-[24px] flex flex-col gap-[12px]">
            ...
            <label class="flex items-center cursor-pointer">
              ...
              >
                ...
                <p class="text-sm text-black capitalize font-bold leading-[20px] tracking-[-0.2px]">{{ $t('prefer_not_to_say') }}</p>
              </div>
            </label>
          </div>
          ...
          <div class="flex gap-[8px] mt-[67px] border-t pt-[16px] border-gray w-full items-center justify-center">
            <button
              @click="skipGenderPickerComponent"
              type="button"
            ...
            <button
              type="submit"
              :class="this.gender === '' ? 'bg-transparent text-black' : 'bg-orange text-white'"
