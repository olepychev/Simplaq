    ...
    <div class="w-full h-full flex overflow-auto md:py-[20px] bg-white md:bg-transparent">
      ...
      >
        <form @submit.prevent="handleSubmit" class="relative w-full h-full flex flex-col justify-between">
          <div
            @click="previousInterestsPickerComponent"
          ...
          <div class="relative w-full flex flex-col gap-[20px]">
            <div class="flex flex-col max-w-[360px] w-full mx-auto">
              ...
              <h6 class="font-bold text-black text-xl mb-[8px] text-center capitalize">{{ $t(`select_profile_picture`) }}</h6>
            ...
            <div class="w-full items-center flex justify-center">
              ...
              >
                ...
                <img v-else id="profile-image-update" class="w-full h-full object-coveer rounded-full" :src="isUploaded" alt="" />
                <div v-if="!isUploaded"
                ...
                >
                  <Icon icon="fluent:delete-12-regular" class="text-base text-black group-hover:text-white cursor-pointer" />
